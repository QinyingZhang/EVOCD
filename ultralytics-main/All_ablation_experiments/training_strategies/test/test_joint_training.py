"""
训练策略消融测试：联合训练（Joint Training）
加载 joint_training 的最佳模型并在测试集上评估性能。
"""
import argparse
import json
import sys
...
if __name__ == "__main__":
    print("=" * 70)
    print("训练策略消融测试：联合训练（Joint Training）")
    print("=" * 70)
    ...
    parser = argparse.ArgumentParser(description="测试训练策略消融：联合训练")
